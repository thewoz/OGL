...
namespace ImGui
{
    ...
    static void processCurrentFrame(FrameIndexType* frame, ImGuiNeoSequencerInternalData& context)
    {
        ...
        const auto hovered = ItemHoverable(pointerRect, GetCurrentWindow()->GetID("##_top_selector_neo"), ImGuiHoveredFlags_AllowWhenOverlappedByItem);
    ...
    static bool createKeyframe(int32_t* frame)
    {
        ...
        bool hovered = ItemHoverable(bb, id, ImGuiHoveredFlags_AllowWhenOverlappedByItem);
...
//
        ...
        *end = endFrameVal;
        ...
        const bool hovered = ItemHoverable(bb, GetCurrentWindow()->GetID("##zoom_slider"), ImGuiHoveredFlags_AllowWhenOverlappedByItem);
