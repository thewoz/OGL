...
#define FONT_ICON_FILE_NAME_FAR "/usr/local/include/ogl/utils/fa-regular-400.ttf"
#define FONT_ICON_FILE_NAME_FAS "/usr/local/include/ogl/utils/fa-solid-900.ttf"
